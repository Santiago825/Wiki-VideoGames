...
function mostrarComen(jComentarios) {
    ...
    jComentarios.map(data => {
        ...
        opcion.innerHTML =`<a onclick='handleModalEdit(${JSON.stringify(data)})'><i class='fa-regular fa-pen-to-square'></i></a><a onclick='eliminar(${JSON.stringify(data)})'><i class='fa-solid fa-trash'></i><a>` 
